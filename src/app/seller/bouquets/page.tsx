  ...
  return (
    <div className="min-h-screen bg-[#FDF6F0]">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <h1 className="font-serif text-3xl text-[#5C3D2E] mb-8">Bouquet Management</h1>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Add bouquet */}
          <div>
            <h2 className="font-serif text-xl text-[#5C3D2E] mb-4">Add New Bouquet</h2>
          ...
          {/* Add flower */}
          <div>
            <h2 className="font-serif text-xl text-[#5C3D2E] mb-4">Manage Flowers</h2>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {flowers.length === 0 && (
                <p className="text-[#5C3D2E]/40 text-sm">No flowers added yet.</p>
              )}
            </div>
          </div>
        </div>
        ...
        <section className="mt-10">
          <h2 className="font-serif text-2xl text-[#5C3D2E] mb-4">All Bouquets ({bouquets.length})</h2>
